package com.kh69.passmath.common.data.preferences

import android.content.Context
import android.content.SharedPreferences
import com.kh69.passmath.common.data.preferences.PreferencesConstants.KEY_TOKEN
import com.kh69.passmath.common.data.preferences.PreferencesConstants.KEY_TOKEN_EXPIRATION_TIME
import com.kh69.passmath.common.data.preferences.PreferencesConstants.KEY_TOKEN_TYPE
import dagger.hilt.android.qualifiers.ApplicationContext
import javax.inject.Inject
import javax.inject.Singleton

@Singleton
class PassMathPreferences @Inject constructor(
    @ApplicationContext context: Context
) : Preferences {

    companion object {
        const val PREFERENCES_NAME = "PASS_MATH_PREFERENCES"
    }
